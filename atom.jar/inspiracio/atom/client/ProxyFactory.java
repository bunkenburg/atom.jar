...
public final class ProxyFactory implements PageContextMaker, PrincipalMaker{
	...
	private PageContext pc=new DummyPageContext(){
		...
		private HttpServletRequest request=new DummyHttpServletRequest(){
			...
			@Override public StringBuffer getRequestURL(){
				...
				buffer.append(ProxyFactory.this.base);
				return buffer;
			}

			/** Returns the logged in user. */
			@Override public Principal getUserPrincipal(){return ProxyFactory.this.principal;}
		};
	...
	private HttpURL getCategoryURL(Class<? extends AtomBean> beanClass){
		...
		builder.append(ProxyFactory.this.base);
